...
// TestProcessManagerUnix tests the Unix process manager functionality
func TestProcessManagerUnix(t *testing.T) {
	pm := &ProcessManager{}
...
// TestProcessManagerPortDetection tests port detection functionality
func TestProcessManagerPortDetection(t *testing.T) {
	pm := &ProcessManager{}
